...
"}")
        ...
        sizePolicy6.setHeightForWidth(self.btnDirget.sizePolicy().hasHeightForWidth())
        self.btnDirget.setSizePolicy(sizePolicy6)
        ...
        sizePolicy7.setHeightForWidth(self.btnApply.sizePolicy().hasHeightForWidth())
        self.btnApply.setSizePolicy(sizePolicy7)
        font7 = QFont()
